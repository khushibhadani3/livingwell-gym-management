                    ...
                    <div class="class-details-text">
                        ...
                        <div class="cd-text">
                            <div class="cd-single-item">
                                <h3>Body buiding</h3>
                                <p>Bodybuilding, a regimen of exercises designed to enhance
                                    the human body’s muscular development and promote general health and fitness.
                                    As a competitive activity, bodybuilding aims to display in artistic fashion 
                                    pronounced muscle mass, symmetry,and definition for overall aesthetic effect.
                                    Barbells, dumbbells, and other resistance training devices are used in the exercises. </p>
                            </div>
                            <div class="cd-single-item">
                                <h3>Trainer</h3>
                                <p>Fitness trainers coach individuals or groups in exercises and other
                                    fitness-related activities. This might include cardiovascular training, 
                                    strength training, or stretching and mobility exercises. If you're 
                                    self-directed and enjoy working with people, a career as a fitness 
                                    trainer could be a good fit.</p>
                            </div>
                        </div>
